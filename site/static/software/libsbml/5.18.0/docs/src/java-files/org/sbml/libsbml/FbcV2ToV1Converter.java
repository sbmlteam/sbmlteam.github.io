 ...
 * <span class="pkg-marker pkg-color-fbc"><a href="group__fbc.html">fbc</a></span>
 Convert &ldquo;fbc&rdquo; Version 2 models to Version 1
 <p>
 ...
 * and converts it to &ldquo;fbc&rdquo; Version&nbsp;1 format.
 <p>
 * {@link FbcV2ToV1Converter} is enabled by creating a {@link ConversionProperties} object
...
public class FbcV2ToV1Converter extends SBMLConverter {
   private long swigCPtr;

   protected FbcV2ToV1Converter(long cPtr, boolean cMemoryOwn)
   {
     super(libsbmlJNI.FbcV2ToV1Converter_SWIGUpcast(cPtr), cMemoryOwn);
     swigCPtr = cPtr;
   }

   protected static long getCPtr(FbcV2ToV1Converter obj)
   {
     return (obj == null) ? 0 : obj.swigCPtr;
   }

   protected static long getCPtrAndDisown (FbcV2ToV1Converter obj)
   {
     long ptr = 0;
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libsbmlJNI.delete_FbcV2ToV1Converter(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
...
/** * @internal */ public
 static void init() {
    libsbmlJNI.FbcV2ToV1Converter_init();
  }

  
/**
   * Creates a new {@link FbcV2ToV1Converter} object.
   */ public
 FbcV2ToV1Converter() {
    this(libsbmlJNI.new_FbcV2ToV1Converter__SWIG_0(), true);
  }

  
/**
   * Copy constructor; creates a copy of an {@link FbcV2ToV1Converter}
   * object.
   <p>
   * @param orig the {@link FbcV2ToV1Converter} object to copy.
   */ public
 FbcV2ToV1Converter(FbcV2ToV1Converter orig) {
    this(libsbmlJNI.new_FbcV2ToV1Converter__SWIG_1(FbcV2ToV1Converter.getCPtr(orig), orig), true);
  }

  
/**
   * Creates and returns a deep copy of this {@link FbcV2ToV1Converter} object.
   <p>
   * @return a (deep) copy of this {@link FbcV2ToV1Converter}.
   */ public
 SBMLConverter cloneObject() {
    long cPtr = libsbmlJNI.FbcV2ToV1Converter_cloneObject(swigCPtr, this);
    return (cPtr == 0) ? null : new FbcV2ToV1Converter(cPtr, true);
  }
...
/**
   ...
   * an {@link FbcV2ToV1Converter} object to find out if the object's
 ...
 boolean matchesProperties(ConversionProperties props) {
    return libsbmlJNI.FbcV2ToV1Converter_matchesProperties(swigCPtr, this, ConversionProperties.getCPtr(props), props);
  }
...
/**
   ...
   * setDocument(SBMLDocument) and
   * with the configuration options set by
   * setProperties(ConversionProperties).
   <p>
   * <p>
 ...
 * returned by this function are:
   ...
   */ public
 int convert() {
    return libsbmlJNI.FbcV2ToV1Converter_convert(swigCPtr, this);
  }
...
/**
 ...
 ConversionProperties getDefaultProperties() {
    return new ConversionProperties(libsbmlJNI.FbcV2ToV1Converter_getDefaultProperties(swigCPtr, this), true);
  }
