 ...
 * <span class="pkg-marker pkg-color-fbc"><a href="group__fbc.html">fbc</a></span>
 SBML Level 3 &ldquo;fbc&rdquo; to COBRA converter.
 <p>
 ...
 * and converts it to COBRA format.
 <p>
 * {@link FbcToCobraConverter} is enabled by creating a {@link ConversionProperties} object
 ...
 * offers one option:
 <p>
 * <ul>
 * <li> <code>'overwriteReactionNotes':</code> should gene associations be written into
 * the 'notes' subelement attached to {@link Reaction} objects, even if a {@link Reaction}
...
public class FbcToCobraConverter extends SBMLConverter {
   private long swigCPtr;

   protected FbcToCobraConverter(long cPtr, boolean cMemoryOwn)
   {
     super(libsbmlJNI.FbcToCobraConverter_SWIGUpcast(cPtr), cMemoryOwn);
     swigCPtr = cPtr;
   }

   protected static long getCPtr(FbcToCobraConverter obj)
   {
     return (obj == null) ? 0 : obj.swigCPtr;
   }

   protected static long getCPtrAndDisown (FbcToCobraConverter obj)
   {
     long ptr = 0;
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libsbmlJNI.delete_FbcToCobraConverter(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
...
/** * @internal */ public
 static void init() {
    libsbmlJNI.FbcToCobraConverter_init();
  }

  
/**
   * Creates a new {@link FbcToCobraConverter} object.
   */ public
 FbcToCobraConverter() {
    this(libsbmlJNI.new_FbcToCobraConverter__SWIG_0(), true);
  }

  
/**
   * Copy constructor; creates a copy of an {@link FbcToCobraConverter}
   * object.
   <p>
   * @param orig the {@link FbcToCobraConverter} object to copy.
   */ public
 FbcToCobraConverter(FbcToCobraConverter orig) {
    this(libsbmlJNI.new_FbcToCobraConverter__SWIG_1(FbcToCobraConverter.getCPtr(orig), orig), true);
  }

  
/**
   * Creates and returns a deep copy of this {@link FbcToCobraConverter} object.
   <p>
   * @return a (deep) copy of this {@link FbcToCobraConverter}.
   */ public
 SBMLConverter cloneObject() {
    long cPtr = libsbmlJNI.FbcToCobraConverter_cloneObject(swigCPtr, this);
    return (cPtr == 0) ? null : new FbcToCobraConverter(cPtr, true);
  }
...
/**
   ...
   * an {@link FbcToCobraConverter} object to find out if the object's
 ...
 boolean matchesProperties(ConversionProperties props) {
    return libsbmlJNI.FbcToCobraConverter_matchesProperties(swigCPtr, this, ConversionProperties.getCPtr(props), props);
  }
 ...
 * returned by this function are:
   ...
   */ public
 int convert() {
    return libsbmlJNI.FbcToCobraConverter_convert(swigCPtr, this);
  }
...
/**
 ...
 ConversionProperties getDefaultProperties() {
    return new ConversionProperties(libsbmlJNI.FbcToCobraConverter_getDefaultProperties(swigCPtr, this), true);
  }
