 ...
 * references to {@link ExternalModelDefinition} objects, it will be necessary to
 ...
 * 'partonomy',
 * 'collection',
 * or <code>null</code> if the value is {@link libsbmlConstants#GROUP_KIND_UNKNOWN GROUP_KIND_UNKNOWN} or
 ...
 */ public
 static String GroupKind_toString(int gk) {
    return libsbmlJNI.GroupKind_toString(gk);
  }

  
/**
 * Returns the enumeration value corresponding to the given string or
 * {@link libsbmlConstants#GROUP_KIND_UNKNOWN GROUP_KIND_UNKNOWN} if there is no such match.
 <p>
 * @param code the string to convert to an enumeration value.
 <p>
 * @return the corresponding value, or {@link libsbmlConstants#GROUP_KIND_UNKNOWN GROUP_KIND_UNKNOWN} if no match is found.
 <p>
 * @note The matching is case-sensitive: 'classification' will return
 * {@link libsbmlConstants#GROUP_KIND_CLASSIFICATION GROUP_KIND_CLASSIFICATION}, but 'Classification'
 * will return {@link libsbmlConstants#GROUP_KIND_UNKNOWN GROUP_KIND_UNKNOWN}.
 */ public
 static int GroupKind_fromString(String code) {
    return libsbmlJNI.GroupKind_fromString(code);
  }

  
/**
 * Predicate returning <code>1</code> (true) or <code>0</code> (false) depending on whether the
 * given enumeration value is valid.
 <p>
 * @param gk the enumeration value to query.
 <p>
 * @return <code>1</code> (true) if the value is
 * {@link libsbmlConstants#GROUP_KIND_CLASSIFICATION GROUP_KIND_CLASSIFICATION},
 * {@link libsbmlConstants#GROUP_KIND_PARTONOMY GROUP_KIND_PARTONOMY}, or
 * {@link libsbmlConstants#GROUP_KIND_COLLECTION GROUP_KIND_COLLECTION};
 * <code>0</code> (false) otherwise (including {@link libsbmlConstants#GROUP_KIND_UNKNOWN GROUP_KIND_UNKNOWN}).
 */ public
 static int GroupKind_isValid(int gk) {
    return libsbmlJNI.GroupKind_isValid(gk);
  }
 ...
 * @param code the string to query.
 <p>
 * @return <code>1</code> (true) if the string is
 * 'classification',
 * 'partonomy', or
 * 'collection';
 * <code>0</code> (false) otherwise.
 <p>
 * @note The matching is case-sensitive: 'classification' will return <code>1</code>
 * (true), but 'Classification' will return <code>0</code> (false).
 */ public
 static int GroupKind_isValidString(String code) {
    return libsbmlJNI.GroupKind_isValidString(code);
  }
 ...
 */ public
 static void parseLayoutAnnotation(XMLNode annotation, ListOfLayouts layouts) {
    libsbmlJNI.parseLayoutAnnotation(XMLNode.getCPtr(annotation), annotation, ListOfLayouts.getCPtr(layouts), layouts);
  }

  
/**
 * Takes an {@link XMLNode} and tries to find the layout annotation node and deletes it if it was found.
 */ public
 static XMLNode deleteLayoutAnnotation(XMLNode pAnnotation) {
    long cPtr = libsbmlJNI.deleteLayoutAnnotation(XMLNode.getCPtr(pAnnotation), pAnnotation);
    return (cPtr == 0) ? null : new XMLNode(cPtr, true);
  }

  
/**
 * Creates an {@link XMLNode} that represents the layouts of the model from the given {@link Model} object.
 */ public
 static XMLNode parseLayouts(Model pModel) {
    long cPtr = libsbmlJNI.parseLayouts(Model.getCPtr(pModel), pModel);
    return (cPtr == 0) ? null : new XMLNode(cPtr, true);
  }
 ...
 */ public
 static void parseSpeciesReferenceAnnotation(XMLNode annotation, SimpleSpeciesReference sr) {
    libsbmlJNI.parseSpeciesReferenceAnnotation(XMLNode.getCPtr(annotation), annotation, SimpleSpeciesReference.getCPtr(sr), sr);
  }

  
/**
 * Takes an {@link XMLNode} and tries to find the layoutId annotation node and deletes it if it was found.
 */ public
 static XMLNode deleteLayoutIdAnnotation(XMLNode pAnnotation) {
    long cPtr = libsbmlJNI.deleteLayoutIdAnnotation(XMLNode.getCPtr(pAnnotation), pAnnotation);
    return (cPtr == 0) ? null : new XMLNode(cPtr, true);
  }

  
/**
 * Creates an {@link XMLNode} that represents the layoutId annotation of the species reference from the given {@link SpeciesReference} object.
 */ public
 static XMLNode parseLayoutId(SimpleSpeciesReference sr) {
    long cPtr = libsbmlJNI.parseLayoutId(SimpleSpeciesReference.getCPtr(sr), sr);
    return (cPtr == 0) ? null : new XMLNode(cPtr, true);
  }
...
/** */ public
 static String BindingStatus_toString(int bindingStatus) {
    return libsbmlJNI.BindingStatus_toString(bindingStatus);
  }

  
/** */ public
 static int BindingStatus_fromString(String s) {
    return libsbmlJNI.BindingStatus_fromString(s);
  }

  
/**
 * Returns the string version of the provided {@link Relation_t} enumeration.
 <p>
 * @param r the {@link Relation_t} enumeration value to convert.
 <p>
 * @return A string corresponding to the given type:
 * 'and',
 * 'or',
 * 'not',
 * or <code>null</code> if the value is {@link libsbmlConstants#MULTI_RELATION_UNKNOWN MULTI_RELATION_UNKNOWN} or
 * another invalid enumeration value.
 <p>
 * <p>
 * @note
 ...
 */ public
 static String Relation_toString(int r) {
    return libsbmlJNI.Relation_toString(r);
  }

  
/**
 * Returns the {@link Relation_t} enumeration corresponding to the given string or
 * {@link libsbmlConstants#MULTI_RELATION_UNKNOWN MULTI_RELATION_UNKNOWN} if there is no such match.
 <p>
 * @param code the string to convert to a {@link Relation_t}.
 <p>
 * @return the corresponding {@link Relation_t} or {@link libsbmlConstants#MULTI_RELATION_UNKNOWN MULTI_RELATION_UNKNOWN} if no match is found.
 <p>
 * @note The matching is case-sensitive: 'and' will return
 * {@link libsbmlConstants#MULTI_RELATION_AND MULTI_RELATION_AND}, but 'And' will return
 * {@link libsbmlConstants#MULTI_RELATION_UNKNOWN MULTI_RELATION_UNKNOWN}.
 */ public
 static int Relation_fromString(String code) {
    return libsbmlJNI.Relation_fromString(code);
  }

  public static int SpreadMethod_fromString(String name) {
    return libsbmlJNI.SpreadMethod_fromString(name);
  }

  public static String SpreadMethod_toString(int method) {
    return libsbmlJNI.SpreadMethod_toString(method);
  }

  public static int TextAnchor_fromString(String str) {
    return libsbmlJNI.TextAnchor_fromString(str);
  }

  public static String TextAnchor_toString(int anchor) {
    return libsbmlJNI.TextAnchor_toString(anchor);
  }
