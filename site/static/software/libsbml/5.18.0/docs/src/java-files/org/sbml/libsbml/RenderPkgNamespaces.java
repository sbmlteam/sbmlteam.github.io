...
public class RenderPkgNamespaces extends SBMLNamespaces {
   ...
   protected RenderPkgNamespaces(long cPtr, boolean cMemoryOwn)
   {
     super(libsbmlJNI.RenderPkgNamespaces_SWIGUpcast(cPtr), cMemoryOwn);
     swigCPtr = cPtr;
   }

   protected static long getCPtr(RenderPkgNamespaces obj)
   {
     return (obj == null) ? 0 : obj.swigCPtr;
   }

   protected static long getCPtrAndDisown (RenderPkgNamespaces obj)
   {
     long ptr = 0;
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libsbmlJNI.delete_RenderPkgNamespaces(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public RenderPkgNamespaces(long level, long version, long pkgVersion, String prefix) throws org.sbml.libsbml.SBMLConstructorException {
    this(libsbmlJNI.new_RenderPkgNamespaces__SWIG_0(level, version, pkgVersion, prefix), true);
  }

  public RenderPkgNamespaces(long level, long version, long pkgVersion) throws org.sbml.libsbml.SBMLConstructorException {
    this(libsbmlJNI.new_RenderPkgNamespaces__SWIG_1(level, version, pkgVersion), true);
  }

  public RenderPkgNamespaces(long level, long version) throws org.sbml.libsbml.SBMLConstructorException {
    this(libsbmlJNI.new_RenderPkgNamespaces__SWIG_2(level, version), true);
  }

  public RenderPkgNamespaces(long level) throws org.sbml.libsbml.SBMLConstructorException {
    this(libsbmlJNI.new_RenderPkgNamespaces__SWIG_3(level), true);
  }

  public RenderPkgNamespaces() throws org.sbml.libsbml.SBMLConstructorException {
    this(libsbmlJNI.new_RenderPkgNamespaces__SWIG_4(), true);
  }

  public RenderPkgNamespaces(RenderPkgNamespaces orig) throws org.sbml.libsbml.SBMLConstructorException {
    this(libsbmlJNI.new_RenderPkgNamespaces__SWIG_5(RenderPkgNamespaces.getCPtr(orig), orig), true);
  }
...
/**
 ...
 SBMLNamespaces cloneObject() {
    long cPtr = libsbmlJNI.RenderPkgNamespaces_cloneObject(swigCPtr, this);
...
/**
   ...
   */ public
 String getURI() {
    return libsbmlJNI.RenderPkgNamespaces_getURI(swigCPtr, this);
  }

  public long getPackageVersion() {
    return libsbmlJNI.RenderPkgNamespaces_getPackageVersion(swigCPtr, this);
  }
...
/**
 ...
 String getPackageName() {
    return libsbmlJNI.RenderPkgNamespaces_getPackageName(swigCPtr, this);
  }
