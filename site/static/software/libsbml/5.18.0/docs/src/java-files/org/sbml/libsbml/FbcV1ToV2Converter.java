 ...
 * <span class="pkg-marker pkg-color-fbc"><a href="group__fbc.html">fbc</a></span>
 Convert &ldquo;fbc&rdquo; Version 1 models to Version 2
 <p>
 ...
 * and converts it to &ldquo;fbc&rdquo; Version&nbsp;2 format.
 <p>
 * {@link FbcV1ToV2Converter} is enabled by creating a {@link ConversionProperties} object
 ...
 * accepts one option:
 <p>
 * <ul>
 * <li> <code>'strict':</code> Should the model created be a strict one (i.e., should
 * all non-specified bounds be filled)?  (Default value of <code>true.</code>)
 *
 * </ul> <p>
 * <p>
...
public class FbcV1ToV2Converter extends SBMLConverter {
   private long swigCPtr;

   protected FbcV1ToV2Converter(long cPtr, boolean cMemoryOwn)
   {
     super(libsbmlJNI.FbcV1ToV2Converter_SWIGUpcast(cPtr), cMemoryOwn);
     swigCPtr = cPtr;
   }

   protected static long getCPtr(FbcV1ToV2Converter obj)
   {
     return (obj == null) ? 0 : obj.swigCPtr;
   }

   protected static long getCPtrAndDisown (FbcV1ToV2Converter obj)
   {
     long ptr = 0;
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libsbmlJNI.delete_FbcV1ToV2Converter(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
...
/** * @internal */ public
 static void init() {
    libsbmlJNI.FbcV1ToV2Converter_init();
  }

  
/**
   * Creates a new {@link FbcV1ToV2Converter} object.
   */ public
 FbcV1ToV2Converter() {
    this(libsbmlJNI.new_FbcV1ToV2Converter__SWIG_0(), true);
  }

  
/**
   * Copy constructor; creates a copy of an {@link FbcV1ToV2Converter}
   * object.
   <p>
   * @param orig the {@link FbcV1ToV2Converter} object to copy.
   */ public
 FbcV1ToV2Converter(FbcV1ToV2Converter orig) {
    this(libsbmlJNI.new_FbcV1ToV2Converter__SWIG_1(FbcV1ToV2Converter.getCPtr(orig), orig), true);
  }

  
/**
   * Creates and returns a deep copy of this {@link FbcV1ToV2Converter}.
   <p>
   * @return a (deep) copy of this {@link FbcV1ToV2Converter}.
   */ public
 SBMLConverter cloneObject() {
    long cPtr = libsbmlJNI.FbcV1ToV2Converter_cloneObject(swigCPtr, this);
    return (cPtr == 0) ? null : new FbcV1ToV2Converter(cPtr, true);
  }
...
/**
   ...
   * an {@link FbcV1ToV2Converter} object to find out if the object's
 ...
 boolean matchesProperties(ConversionProperties props) {
    return libsbmlJNI.FbcV1ToV2Converter_matchesProperties(swigCPtr, this, ConversionProperties.getCPtr(props), props);
  }
 ...
 * returned by this function are:
   ...
   */ public
 int convert() {
    return libsbmlJNI.FbcV1ToV2Converter_convert(swigCPtr, this);
  }
...
/**
   ...
   */ public
 boolean getStrict() {
    return libsbmlJNI.FbcV1ToV2Converter_getStrict(swigCPtr, this);
  }
...
/**
 ...
 ConversionProperties getDefaultProperties() {
    return new ConversionProperties(libsbmlJNI.FbcV1ToV2Converter_getDefaultProperties(swigCPtr, this), true);
  }
