 ...
 * <span class="pkg-marker pkg-color-fbc"><a href="group__fbc.html">fbc</a></span>
 COBRA to SBML Level 3 &ldquo;fbc&rdquo; converter.
 <p>
 ...
 * &ldquo;fbc&rdquo; Version&nbsp;2 format.
 <p>
 * {@link CobraToFbcConverter} is enabled by creating a {@link ConversionProperties} object
 ...
 * {@link SBMLDocument#convert(ConversionProperties)}.  The converter
 * offers two options:
 <p>
 * <ul>
 * <li> <code>'checkCompatibility':</code> whether to check the SBML Level/Version
 * compatibility
 * <li> <code>'removeUnits':</code> whether to remove unit definitions
 *
 * </ul> <p>
 * <p>
...
public class CobraToFbcConverter extends SBMLConverter {
   private long swigCPtr;

   protected CobraToFbcConverter(long cPtr, boolean cMemoryOwn)
   {
     super(libsbmlJNI.CobraToFbcConverter_SWIGUpcast(cPtr), cMemoryOwn);
     swigCPtr = cPtr;
   }

   protected static long getCPtr(CobraToFbcConverter obj)
   {
     return (obj == null) ? 0 : obj.swigCPtr;
   }

   protected static long getCPtrAndDisown (CobraToFbcConverter obj)
   {
     long ptr = 0;
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        libsbmlJNI.delete_CobraToFbcConverter(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
...
/** * @internal */ public
 static void init() {
    libsbmlJNI.CobraToFbcConverter_init();
  }

  
/**
   * Creates a new {@link CobraToFbcConverter} object.
   */ public
 CobraToFbcConverter() {
    this(libsbmlJNI.new_CobraToFbcConverter__SWIG_0(), true);
  }

  
/**
   * Copy constructor; creates a copy of an {@link CobraToFbcConverter}
   * object.
   <p>
   * @param orig the {@link CobraToFbcConverter} object to copy.
   */ public
 CobraToFbcConverter(CobraToFbcConverter orig) {
    this(libsbmlJNI.new_CobraToFbcConverter__SWIG_1(CobraToFbcConverter.getCPtr(orig), orig), true);
  }

  
/**
   * Creates and returns a deep copy of this {@link CobraToFbcConverter} object.
   <p>
   * @return a (deep) copy of this {@link CobraToFbcConverter}.
   */ public
 SBMLConverter cloneObject() {
    long cPtr = libsbmlJNI.CobraToFbcConverter_cloneObject(swigCPtr, this);
    return (cPtr == 0) ? null : new CobraToFbcConverter(cPtr, true);
  }
...
/**
   ...
   * an {@link CobraToFbcConverter} object to find out if the object's
 ...
 boolean matchesProperties(ConversionProperties props) {
    return libsbmlJNI.CobraToFbcConverter_matchesProperties(swigCPtr, this, ConversionProperties.getCPtr(props), props);
  }
 ...
 * returned by this function are:
   ...
   */ public
 int convert() {
    return libsbmlJNI.CobraToFbcConverter_convert(swigCPtr, this);
  }
...
/**
 ...
 ConversionProperties getDefaultProperties() {
    return new ConversionProperties(libsbmlJNI.CobraToFbcConverter_getDefaultProperties(swigCPtr, this), true);
  }

  
/**
   * Returns <code>true</code> if the option property to check Level and Version of the
   * source document (<code>'checkCompatibility'</code>) is <code>true.</code>
   <p>
   * @return <code>true</code> if the option <code>'checkCompatibility'</code> has been set to
   * <code>true</code>, <code>false</code> otherwise.
   */ public
 boolean checkCompatibility() {
    return libsbmlJNI.CobraToFbcConverter_checkCompatibility(swigCPtr, this);
  }
