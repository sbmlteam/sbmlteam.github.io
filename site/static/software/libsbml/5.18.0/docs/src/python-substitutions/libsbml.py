...
ALLOWED_CHILDREN_ANY = _libsbml.ALLOWED_CHILDREN_ANY
    ## @var long ALLOWED_CHILDREN_ANY
    ## @brief Extended math added in L3V2.

ALLOWED_CHILDREN_ATLEAST = _libsbml.ALLOWED_CHILDREN_ATLEAST
    ## @var long ALLOWED_CHILDREN_ATLEAST
    ## @brief Extended math added by the 'distrib' package.

ALLOWED_CHILDREN_EXACTLY = _libsbml.ALLOWED_CHILDREN_EXACTLY
    ## @var long ALLOWED_CHILDREN_EXACTLY
    ## @brief Extended math.

ALLOWED_CHILDREN_UNKNOWN = _libsbml.ALLOWED_CHILDREN_UNKNOWN
    ## @var long ALLOWED_CHILDREN_UNKNOWN
    ## @brief Unknown node: will not produce any MathML.
...
EM_ARRAYS = _libsbml.EM_ARRAYS
    ## @var long EM_ARRAYS
    ## @brief Extended math added by the 'arrays' package.
...
AST_END_OF_CORE = _libsbml.AST_END_OF_CORE
    ## @var long AST_END_OF_CORE
    ##
    ## One of the possible ASTNode types.  Marker for the end of values
    ## in SBML Core.
...
L3P_PARSE_PACKAGE_MATH_AS_GENERIC = _libsbml.L3P_PARSE_PACKAGE_MATH_AS_GENERIC
    ## @var long L3P_PARSE_PACKAGE_MATH_AS_GENERIC

L3P_PARSE_PACKAGE_MATH_DIRECTLY = _libsbml.L3P_PARSE_PACKAGE_MATH_DIRECTLY
    ## @var long L3P_PARSE_PACKAGE_FUNCTIONS_DIRECTLY
