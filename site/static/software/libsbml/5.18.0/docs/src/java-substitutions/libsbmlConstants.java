...
public interface libsbmlConstants
{
     ...
     * One of the possible libSBML operation return codes.
     * <p>
     * This code has the following meaning: For SBML Level 3 Version 2, use
     * the IdAttribute functions.
     */
    ...
    /**
     * Enumeration value for allowed children types.
     */
    ...
    /**
     * Enumeration value for extended math types.
     */
     ...
     * a type whose value is one of the elements of this enumeration.
     */
    public final static int AST_END_OF_CORE = AST_RELATIONAL_NEQ + 1;
     ...
     * a type whose value is one of the elements of this enumeration.
     */
    public final static int AST_FUNCTION_MAX = AST_END_OF_CORE + 1;
    ...
    /**
     * Parse the percent ('%') symbol as an expanded 'piecewise' function
     * (valid in all levels/versions).
     */
    ...
    /**
     * Parse the functions added in SBML Level 3 'distrib'.
     */
    public final static boolean L3P_PARSE_PACKAGE_MATH_DIRECTLY = true;


    /**
     * Parse the '%' symbol as an expanded 'piecewise'
     * function (valid in all Levels/Versions).
     */
    ...
    /**
     * One of the settings in L3Parser affects whether the <code>%</code>
     * symbol (modulo) is parsed as a piecewise equation that returns the
     * modulo value of the entries on either side of the symbol, or whether
     * it is parsed as the MathML <code>rem</code> function, which was
     * allowed in SBML Level&nbsp;3 Version&nbsp;2, but not in previous
     * Level/Versions.  The latter is more succinct, but might not be legal
     * SBML for the desired target SBML document.
     *
     * This value means use the <code>rem</code> MathML function
     * (@sbmlconstant{AST_FUNCTION_REM,ASTNodeType_t}).
     */
     ...
     * SBML for the desired target SBML document.
     *
     * This value means use a piecewise function
     * (@sbmlconstant{AST_FUNCTION_PIECEWISE,ASTNodeType_t}) to encode the
     * modulo rule explicitly.
     */
     ...
     * meaning of this particular error code.
     */
    public final static int OnlyCiInsideBVar = 20308;
  ...
  // GroupsSBMLErrorCode_t 
     ...
     * enumeration defined by the libSBML &ldquo;multi&rdquo; extension
     * for objects in the SBML Level&nbsp;3 Multistate, Multicomponent
     * and Multicompartment Species package.
     */
    public final static int SBML_MULTI_POSSIBLE_SPECIES_FEATURE_VALUE = 1400;
     ...
     * and Multicompartment Species package.
     */
    public final static int SBML_MULTI_SPECIES_FEATURE_VALUE = 1401;
     ...
     * and Multicompartment Species package.
     */
    public final static int SBML_MULTI_COMPARTMENT_REFERENCE = 1402;
     ...
     * and Multicompartment Species package.
     */
    public final static int SBML_MULTI_SPECIES_TYPE_INSTANCE = 1403;
     ...
     * and Multicompartment Species package.
     */
    public final static int SBML_MULTI_IN_SPECIES_TYPE_BOND = 1404;
     ...
     * and Multicompartment Species package.
     */
    public final static int SBML_MULTI_OUTWARD_BINDING_SITE = 1405;
     ...
     * and Multicompartment Species package.
     */
    public final static int SBML_MULTI_SPECIES_FEATURE_TYPE = 1406;
     ...
     * and Multicompartment Species package.
     */
    public final static int SBML_MULTI_SPECIES_TYPE_COMPONENT_INDEX = 1407;
     ...
     * and Multicompartment Species package.
     */
    public final static int SBML_MULTI_SPECIES_FEATURE = 1408;
     ...
     * and Multicompartment Species package.
     */
    public final static int SBML_MULTI_SPECIES_TYPE_COMPONENT_MAP_IN_PRODUCT = 1409;
     ...
     * and Multicompartment Species package.
     */
    public final static int SBML_MULTI_SPECIES_TYPE = 1410;
     ...
     * and Multicompartment Species package.
     */
    public final static int SBML_MULTI_BINDING_SITE_SPECIES_TYPE = 1411;
     ...
     * and Multicompartment Species package.
     */
    public final static int SBML_MULTI_SUBLIST_OF_SPECIES_FEATURES = 1413;
     ...
     * and Multicompartment Species package.
     */
    public final static int MULTI_RELATION_AND = 0;
     ...
     * and Multicompartment Species package.
     */
    public final static int MULTI_RELATION_OR = MULTI_RELATION_AND + 1;
     ...
     * and Multicompartment Species package.
     */
    public final static int MULTI_RELATION_NOT = MULTI_RELATION_OR + 1;
     ...
     * and Multicompartment Species package.
     */
    public final static int MULTI_RELATION_UNKNOWN = MULTI_RELATION_NOT + 1;
     ...
     * and Multicompartment Species package.
     */
    public final static int MULTI_BINDING_STATUS_BOUND = 0;
     ...
     * and Multicompartment Species package.
     */
    public final static int MULTI_BINDING_STATUS_EITHER = MULTI_BINDING_STATUS_BOUND + 1;
     ...
     * and Multicompartment Species package.
     */
    public final static int MULTI_BINDING_STATUS_UNBOUND = MULTI_BINDING_STATUS_EITHER + 1;
     ...
     * and Multicompartment Species package.
     */
    public final static int MULTI_BINDING_STATUS_UNKNOWN = MULTI_BINDING_STATUS_UNBOUND + 1;


    /**
     * <span class="pkg-marker pkg-color-render">render</span> A value in an
     * enumeration defined by the libSBML &ldquo;render&rdquo; extension
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
    public final static int SBML_RENDER_COLORDEFINITION         = 1000; 
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_ELLIPSE = SBML_RENDER_COLORDEFINITION + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_GLOBALRENDERINFORMATION = SBML_RENDER_ELLIPSE + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_GLOBALSTYLE = SBML_RENDER_GLOBALRENDERINFORMATION + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_GRADIENTDEFINITION = SBML_RENDER_GLOBALSTYLE + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_GRADIENT_STOP = SBML_RENDER_GRADIENTDEFINITION + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_GROUP = SBML_RENDER_GRADIENT_STOP + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_IMAGE = SBML_RENDER_GROUP + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_LINEENDING = SBML_RENDER_IMAGE + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_LINEARGRADIENT = SBML_RENDER_LINEENDING + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_LINESEGMENT = SBML_RENDER_LINEARGRADIENT + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_LISTOFGLOBALSTYLES = SBML_RENDER_LINESEGMENT + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_LISTOFLOCALSTYLES = SBML_RENDER_LISTOFGLOBALSTYLES + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_LOCALRENDERINFORMATION = SBML_RENDER_LISTOFLOCALSTYLES + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_LOCALSTYLE = SBML_RENDER_LOCALRENDERINFORMATION + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_POLYGON = SBML_RENDER_LOCALSTYLE + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_RADIALGRADIENT = SBML_RENDER_POLYGON + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_RECTANGLE = SBML_RENDER_RADIALGRADIENT + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_RELABSVECTOR = SBML_RENDER_RECTANGLE + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_CUBICBEZIER = SBML_RENDER_RELABSVECTOR + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_CURVE = SBML_RENDER_CUBICBEZIER + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_POINT = SBML_RENDER_CURVE + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_TEXT = SBML_RENDER_POINT + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_TRANSFORMATION2D = SBML_RENDER_TEXT + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_DEFAULTS = SBML_RENDER_TRANSFORMATION2D + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_TRANSFORMATION = SBML_RENDER_DEFAULTS + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_GRAPHICALPRIMITIVE1D = SBML_RENDER_TRANSFORMATION + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_GRAPHICALPRIMITIVE2D = SBML_RENDER_GRAPHICALPRIMITIVE1D + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_STYLE_BASE = SBML_RENDER_GRAPHICALPRIMITIVE2D + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int SBML_RENDER_RENDERINFORMATION_BASE = SBML_RENDER_STYLE_BASE + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int GRADIENT_SPREADMETHOD_PAD = 0;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int GRADIENT_SPREADMETHOD_REFLECT = GRADIENT_SPREADMETHOD_PAD + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int GRADIENT_SPREADMETHOD_REPEAT = GRADIENT_SPREADMETHOD_REFLECT + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int GRADIENT_SPREAD_METHOD_INVALID = GRADIENT_SPREADMETHOD_REPEAT + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int FILL_RULE_UNSET = 0;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int FILL_RULE_NONZERO = FILL_RULE_UNSET + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int FILL_RULE_EVENODD = FILL_RULE_NONZERO + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int FILL_RULE_INHERIT = FILL_RULE_EVENODD + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int FONT_FAMILY_SERIF = 0;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int FONT_FAMILY_SANS_SERIF = FONT_FAMILY_SERIF + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int FONT_FAMILY_MONOSPACE = FONT_FAMILY_SANS_SERIF + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int FONT_FAMILY_INVALID = FONT_FAMILY_MONOSPACE + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int FONT_WEIGHT_UNSET = 0;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int FONT_WEIGHT_NORMAL = FONT_WEIGHT_UNSET + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int FONT_WEIGHT_BOLD = FONT_WEIGHT_NORMAL + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int FONT_WEIGHT_INVALID = FONT_WEIGHT_BOLD + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int FONT_STYLE_UNSET = 0;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int FONT_STYLE_NORMAL = FONT_STYLE_UNSET + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int FONT_STYLE_ITALIC = FONT_STYLE_NORMAL + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int FONT_STYLE_INVALID = FONT_STYLE_ITALIC + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int V_TEXTANCHOR_UNSET = 0;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int V_TEXTANCHOR_TOP = V_TEXTANCHOR_UNSET + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int V_TEXTANCHOR_MIDDLE = V_TEXTANCHOR_TOP + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int V_TEXTANCHOR_BOTTOM = V_TEXTANCHOR_MIDDLE + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int V_TEXTANCHOR_BASELINE = V_TEXTANCHOR_BOTTOM + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int V_TEXTANCHOR_INVALID = V_TEXTANCHOR_BASELINE + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int H_TEXTANCHOR_UNSET = 0;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int H_TEXTANCHOR_START = H_TEXTANCHOR_UNSET + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int H_TEXTANCHOR_MIDDLE = H_TEXTANCHOR_START + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int H_TEXTANCHOR_END = H_TEXTANCHOR_MIDDLE + 1;
     ...
     * for objects in the SBML Level&nbsp;3 Rendering package.
     */
     public final static int H_TEXTANCHOR_INVALID = H_TEXTANCHOR_END + 1;
}
