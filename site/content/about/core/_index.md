...
Email address for contacting the SBML Editors: [sbml-editors@googlegroups.com](mailto:sbml-editors@googlegroups.com)
  ...
  - **Rahuman Sheriff** (PhD in Chemical Biology) is a project leader at the [European Bioinformatics Institute (EMBL-EBI)](https://www.ebi.ac.uk/), Cambridge UK. He leads the [BioModels](https://www.ebi.ac.uk/biomodels/) team to curate and annotate systems models in SBML as well as develop platform to host and exchange models in standard formats.
